...
def handler(context, event):
    ...
    try:
        ...
        topsoil_id_field = FunctionConfig.topsoil_id_field
        normalized_topsoil_properties = FunctionConfig.normalized_topsoil_properties
        ...
        download_cmd = {
            ...
            "sourceID": source_id,
            "topsoilIdField": topsoil_id_field,
            "normalizedProperties": normalized_topsoil_properties,
            "version": version}
...
class FunctionConfig(object):
    ...
    source_id = "topsoil:esdac"

    topsoil_id_field = "POINT_ID"

    normalized_topsoil_properties = dict([
        ('pointID',{'sourceProp': 'POINT_ID'}),
        ('coarse',{'sourceProp': 'coarse'}),
        ('clay',{'sourceProp': 'clay'}),
        ('silt',{'sourceProp': 'silt'}),
        ('sand',{'sourceProp': 'sand'}),
        ('pHinH2O',{'sourceProp': 'pHinH2O'}),
        ('pHinCaCl2',{'sourceProp': 'pHinCaCl2'}),
        ('OC',{'sourceProp': 'OC'}),
        ('CaCO3',{'sourceProp': 'CaCO3'}),
        ('N',{'sourceProp': 'N'}),
        ('P',{'sourceProp': 'P'}),
        ('K',{'sourceProp': 'K'}),
        ('CEC',{'sourceProp': 'CEC'})])
